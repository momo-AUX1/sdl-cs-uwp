...
typedef void (*PFN_UGL_SDL_GamepadVibrate)(double leftMotor, double rightMotor, double leftTrigger, double rightTrigger);
...
extern PFN_UGL_SDL_GamepadVibrate g_pfnUGL_SDL_GamepadVibrate;
